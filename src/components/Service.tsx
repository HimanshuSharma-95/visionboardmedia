...
// Debounce helper so resize doesn't fire on every pixel while rotating/scrolling on mobile
...
export default function Services() {
  ...
  if (isMobile) {
    return (
      <section className="relative overflow-hidden bg-[#09090B] px-5 py-20">
        {/* Glow — smaller + lighter blur so mobile GPUs don't choke on repaint */}
        <div
          className="pointer-events-none absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(124,58,237,0.18)_0%,transparent_70%)] blur-2xl"
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-28 mt-24 flex h-130 items-center justify-center">
        ...
        <motion.div
          style={{ x: x2, y: 8, scale, willChange: "transform" }}
          className={desktopCardClass}
        >
          <ServiceCard service={services[1]} />
        </motion.div>
