...
function LogoItem({
  ...
  return (
    <img
      ...
      decoding="async"
      draggable={false}
      className="h-24 w-auto max-w-37.5 shrink-0 object-contain brightness-75 contrast-125 transition-transform duration-200 ease-out hover:scale-105 sm:h-16 sm:max-w-42.5 md:h-24 md:max-w-55 lg:h-28 lg:max-w-60"
    />
  );
}
